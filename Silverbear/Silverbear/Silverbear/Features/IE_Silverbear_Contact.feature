...
Scenario: 02 SilverBearCRM_TS1_02_CreateContactConfigFields
This test creates contact with available fields in SilverBear CRM and verifies its integration in Silverbear CRM only

	When I click on "New" link
	And I Fill all the mandatory fields Title,First Name,Last Name,DOB,Street 1,City,County,Postal Code,Country,Home email address
	And I Fill all the non mandatory fields
	And I click on "Save" button of Contact page
